  ...
  return (
    <>
      ...
      <div style={{ marginBottom: "32px" }}>
        <h3 style={{ margin: "0 0 16px", fontSize: "14px", fontWeight: 700, color: "var(--color-text-muted)" }}>
                  ...
                  <tr key={r.id} style={{ borderBottom: "1px solid var(--border-container)" }}>
                    ...
                    <td style={{ padding: "12px 16px", display: "flex", gap: "8px" }}>
                      <button
                        ...
                        disabled={saving}
                        style={{
                          background: "#16a34a", border: "none", color: "var(--color-text)",
                      ...
                      <button
                        ...
                        disabled={saving}
                        style={{
                          background: "#c21a25", border: "none", color: "var(--color-text)",
                          borderRadius: "6px", padding: "6px 12px", fontSize: "12px",
                          fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", gap: "4px"
                        }}
                      >
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            ...
            <tbody>
              {registros.data.filter(r => r.estado !== "pendiente").map((r, idx) => {
                ...
                return (
                  <tr key={r.id} style={{ borderBottom: "1px solid var(--border-container)", background: idx % 2 === 0 ? "transparent" : "rgba(16, 185, 129, 0.02)" }}>
                    ...
                    <td style={{ padding: "12px 16px", color: "var(--color-text)", fontSize: "13px" }}>
                      {r.nombre_completo}
                    </td>
                    <td style={{ padding: "12px 16px", color: "var(--color-text-muted)", fontSize: "13px" }}>
                      {r.rol_solicitado}
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "16px" }}>
              <div>
                <div style={{ color: "var(--color-text)", fontWeight: 700, fontSize: "16px" }}>Rechazar Solicitud de Registro</div>
            ...
            <textarea
              ...
              style={{
                ...
                color: "var(--color-text)", padding: "12px", fontSize: "13px",
            ...
            <div style={{ display: "flex", gap: "8px", marginTop: "16px", justifyContent: "flex-end" }}>
              ...
              <button onClick={handleRechazarRegistro} disabled={saving} style={{
                ...
                color: "var(--color-text)", borderRadius: "8px", padding: "8px 20px",
